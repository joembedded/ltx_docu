...
**Stand:** 2026-05-04  
**Quellen:**
- **BLX.js** (Bluetooth-Worker): [github.com/joembedded/blxdashboard 🔒](https://github.com/joembedded/blxdashboard) *(privates Repo – nur für Collaborators)*
...
- **Privates Repo** (Quellcode, nur für Collaborators):  
